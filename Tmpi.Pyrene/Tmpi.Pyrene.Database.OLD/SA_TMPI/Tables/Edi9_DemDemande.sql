CREATE TABLE [SA_TMPI].[Edi9_DemDemande] (
    ...
    CONSTRAINT [PK_Edi9_DemDemande] PRIMARY KEY CLUSTERED ([CleEdiDemande] ASC),
    CONSTRAINT [UN_Edi9_DemDemande] UNIQUE NONCLUSTERED ([TypReferentiel] ASC, [NumDemande] ASC)
);
