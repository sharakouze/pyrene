...
namespace Tmpi.Pyrene.Services.ServiceInterface
{
	...
	public partial class GenSocieteService : Service
	{
		...
		public GenSociete Get(GetGenSociete request)
		{
            ...
            {
                var undefFields = ModelDefinitionHelper.GetUndefinedFields<GenSociete>(request.Fields);
                if (undefFields.Any())
                {
		...
		public void Patch(PatchGenSociete request)
		{
            ...
            var undefFields = ModelDefinitionHelper.GetUndefinedFields<GenSociete>(patchDic.Keys);
            if (undefFields.Any())
            {
                string str = string.Join(", ", undefFields.Select(f => "'" + f + "'"));
                throw new ArgumentException(
