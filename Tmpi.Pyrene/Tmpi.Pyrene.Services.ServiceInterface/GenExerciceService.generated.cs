...
namespace Tmpi.Pyrene.Services.ServiceInterface
{
	...
	public partial class GenExerciceService : Service
	{
		...
		public GenExercice Get(GetGenExercice request)
		{
            ...
            {
                var undefFields = ModelDefinitionHelper.GetUndefinedFields<GenExercice>(request.Fields);
                if (undefFields.Any())
                {
		...
		public void Patch(PatchGenExercice request)
		{
            ...
            var undefFields = ModelDefinitionHelper.GetUndefinedFields<GenExercice>(patchDic.Keys);
            if (undefFields.Any())
            {
                string str = string.Join(", ", undefFields.Select(f => "'" + f + "'"));
                throw new ArgumentException(
