...
namespace Tmpi.Pyrene.Services.ServiceModel.Messages
{
    ...
    /// <summary>
    /// Réponse à la requête <see cref="SelectGenFourn"/>.
    /// </summary>
	public partial class SelectGenFournResponse
	{
		...
		public List<GenFourn> Results { get; set; }
	}

	/// <summary>
	/// Retourne une ressource Fourn à partir de son id.
	/// </summary>
	/// <seealso cref="GenFourn"/>
	[Route("/Fourn/{CleFourn}", HttpVerbs.Get, Summary = "Retourne une ressource Fourn à partir de son id.")]
	...
	/// <summary>
	/// Modifie partiellement une ressource Fourn à partir de son id.
	/// </summary>
	/// <seealso cref="GenFourn"/>
	[Route("/Fourn/{CleFourn}", HttpVerbs.Patch, Summary = "Modifie partiellement une ressource Fourn à partir de son id.")]
    [ApiResponse(HttpStatusCode.BadRequest, "La ressource ne contient pas tous les champs demandés.")]
    [ApiResponse(HttpStatusCode.NotFound, "La ressource spécifiée est introuvable.")]
	...
	/// <summary>
	/// Retourne le résultat d'une recherche sur les ressources Fourn.
	/// </summary>
	/// <seealso cref="GenFourn"/>
	[Route("/Fourn/Recherche/{Text}", HttpVerbs.Get, Summary = "Retourne le résultat d'une recherche sur les ressources Fourn.")]
	public partial class SearchGenFourn : IReturn<List<BasicEntity>>, IGet
	{
        /// <summary>
        /// Texte à rechercher.
        /// </summary>
