...
namespace Tmpi.Pyrene.Services.ServiceModel
{
	...
	/// </summary>
	[Route("/GenMandat/{CodMandat}/GenMandatMandataire/{ClePersonne}/{CleSociete}/{CleSecteur}/{CleService}", HttpVerbs.Delete, Summary = "Supprime une ressource GenMandatMandataire.")]
