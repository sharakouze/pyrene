...
namespace Tmpi.Pyrene.Services.ServiceModel
{
	...
	/// </summary>
	[Route("/Mandat/{CodMandat}/Mandataire/{ClePersonne}/{CleSociete}/{CleSecteur}/{CleService}", HttpVerbs.Patch, Summary = "Modifie partiellement une ressource 'GenMandatMandataire'.")]
