...
namespace Tmpi.Pyrene.Services.ServiceModel.Types
{
		...
		IAuditable
	{
		...
		/// </summary>
		[Required]
		[ApiMember(Description = "Date de début.", DataType = SwaggerDataTypes.Date, IsRequired = true)]
		...
		/// </summary>
		[Required]
		[ApiMember(Description = "Date de fin.", DataType = SwaggerDataTypes.Date, IsRequired = true)]
