...
namespace Tmpi.Pyrene.Services.ServiceModel
{
	...
	public partial class GetGenFournBanque : IReturn<GenFournBanque>
	{
        ...
        /// </summary>
        [ApiMember(Description = "Id de la ressource GenFournBanque à retourner.", IsRequired = true, DataType = SwaggerDataTypes.Integer, ParameterType = SwaggerParameterTypes.Path)]
