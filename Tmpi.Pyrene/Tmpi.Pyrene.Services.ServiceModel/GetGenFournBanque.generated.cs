...
namespace Tmpi.Pyrene.Services.ServiceModel
{
	...
	public partial class GetGenFournBanque : IReturn<GenFournBanque>
	{
        ...
        /// </summary>
        [ApiMember(Description = "Id de la ressource GenFournBanque à retourner.", DataType = SwaggerDataTypes.Int, IsRequired = true, ParameterType = SwaggerParameterTypes.Path)]
