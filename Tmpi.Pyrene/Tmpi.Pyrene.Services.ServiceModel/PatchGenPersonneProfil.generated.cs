...
{
	/// <summary>
	/// Modifie partiellement une ressource Profil (Personne).
	/// </summary>
	/// <seealso cref="GenPersonneProfil" />
	[Route("/Personne/Profil/{CleProfil}", HttpVerbs.Patch, Summary = "Modifie partiellement une ressource Profil (Personne).")]
