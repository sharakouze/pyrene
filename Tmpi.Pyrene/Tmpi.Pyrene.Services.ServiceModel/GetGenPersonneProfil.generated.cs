...
namespace Tmpi.Pyrene.Services.ServiceModel
{
	...
	public partial class GetGenPersonneProfil : IReturn<GenPersonneProfil>
	{
        ...
        /// </summary>
        [ApiMember(Description = "Id de la ressource GenPersonneProfil à retourner.", DataType = SwaggerDataTypes.Int, IsRequired = true, ParameterType = SwaggerParamTypes.Path)]
