...
namespace Tmpi.Pyrene.Services.ServiceModel
{
	...
	/// </summary>
	[Route("/GenMandat/{CodMandat}/GenMandatMandataire/{ClePersonne}/{CleSociete}/{CleSecteur}/{CleService}", HttpVerbs.Get, Summary = "Retourne une ressource GenMandatMandataire.")]
