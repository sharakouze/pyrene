...
{
	/// <summary>
	/// Retourne un ensemble de ressources <see cref="GenService" />.
	/// </summary>
	[Route("/GenService", HttpVerbs.Get, Summary = "Retourne un ensemble de ressources GenService.")]
	public partial class FindGenService : IReturn<BasicEntity[]>
	{
        /// <summary>
        /// Texte à rechercher.
        /// </summary>
