...
{
	/// <summary>
	/// Retourne des prédictions sur les ressources <see cref="GenMandat" />.
	/// </summary>
	[Route("/GenMandat/Autocomplete/{Text}", HttpVerbs.Get, Summary = "Retourne des prédictions sur les ressources GenMandat.")]
