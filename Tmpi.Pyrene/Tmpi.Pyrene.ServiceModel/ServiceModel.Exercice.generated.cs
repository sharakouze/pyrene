...
namespace Tmpi.Pyrene.ServiceModel
{
	...
	/// </summary>
	[Route("/Exercice/{Id}", HttpVerbs.Get, Summary = "Retourne une entité Exercice à partir de son id", Notes = SwaggerDescriptions.GetByIdRequestNotes)]
	[ApiResponse(HttpStatusCode.BadRequest, "L'entité Exercice ne contient pas tous les champs demandés")]
	...
	/// </summary>
	[Route("/Exercice/{Id}", HttpVerbs.Delete, Summary = "Supprime une entité Exercice à partir de son id", Notes = SwaggerDescriptions.DeleteByIdRequestNotes)]
	[ApiResponse(HttpStatusCode.NotFound, "L'entité Exercice spécifiée est introuvable")]
	...
	/// </summary>
	[Route("/Exercice/{Id}", HttpVerbs.Patch, Summary = "Modifie partiellement une entité Exercice à partir de son id", Notes = SwaggerDescriptions.PatchByIdRequestNotes)]
	[ApiResponse(HttpStatusCode.BadRequest, "L'entité Exercice ne contient pas tous les champs demandés")]
	[ApiResponse(HttpStatusCode.NotFound, "L'entité Exercice spécifiée est introuvable")]
