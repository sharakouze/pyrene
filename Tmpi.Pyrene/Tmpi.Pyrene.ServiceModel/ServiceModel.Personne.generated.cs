...
namespace Tmpi.Pyrene.ServiceModel
{
	...
	/// </summary>
	public partial class SelectPersonneResponse : IHasResponseStatus
	{
		/// <summary>
		...
		/// <summary>
		/// Collection des entités <see cref="Personne"/>.
		/// </summary>
	...
	/// </summary>
	[Route("/Personne/{Id}", HttpVerbs.Get, Summary = "Retourne une entité Personne à partir de son id", Notes = SwaggerDescriptions.GetByIdRequestNotes)]
	[ApiResponse(HttpStatusCode.BadRequest, "L'entité Personne ne contient pas tous les champs demandés")]
	...
	/// </summary>
	[Route("/Personne/{Id}", HttpVerbs.Delete, Summary = "Supprime une entité Personne à partir de son id", Notes = SwaggerDescriptions.DeleteByIdRequestNotes)]
	[ApiResponse(HttpStatusCode.NotFound, "L'entité Personne spécifiée est introuvable")]
	...
	/// </summary>
	[Route("/Personne/{Id}", HttpVerbs.Patch, Summary = "Modifie partiellement une entité Personne à partir de son id", Notes = SwaggerDescriptions.PatchByIdRequestNotes)]
	[ApiResponse(HttpStatusCode.BadRequest, "L'entité Personne ne contient pas tous les champs demandés")]
	[ApiResponse(HttpStatusCode.NotFound, "L'entité Personne spécifiée est introuvable")]
