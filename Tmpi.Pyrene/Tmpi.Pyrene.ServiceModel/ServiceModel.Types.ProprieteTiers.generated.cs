...
{
	[Schema("Gen")]
	[Route("/ProprieteTiers", HttpVerbs.Post, Summary = "Ajoute ou remplace une entité ProprieteTiers à partir de son id", Notes = SwaggerDescriptions.UpsertRequestNotes)]
	...
	public partial class ProprieteTiers : IHasId<int>, IAuditable, IReturn<ProprieteTiers>, IPost
	{
		/// <summary>
		...
		public string CodProprieteTiers { get; set; }
		...
		public string LibProprieteTiers { get; set; }
		...
		public string TxtProprieteTiers { get; set; }
