...
namespace Tmpi.Pyrene.ServiceModel
{
	...
	/// </summary>
	[Route("/Compteur/Valeur/{Id}", HttpVerbs.Get, Summary = "Retourne une entité CompteurValeur à partir de son id", Notes = SwaggerDescriptions.GetByIdRequestNotes)]
	[ApiResponse(HttpStatusCode.BadRequest, "L'entité CompteurValeur ne contient pas tous les champs demandés")]
	...
	/// </summary>
	[Route("/Compteur/Valeur/{Id}", HttpVerbs.Delete, Summary = "Supprime une entité CompteurValeur à partir de son id", Notes = SwaggerDescriptions.DeleteByIdRequestNotes)]
	[ApiResponse(HttpStatusCode.NotFound, "L'entité CompteurValeur spécifiée est introuvable")]
	...
	/// </summary>
	[Route("/Compteur/Valeur/{Id}", HttpVerbs.Patch, Summary = "Modifie partiellement une entité CompteurValeur à partir de son id", Notes = SwaggerDescriptions.PatchByIdRequestNotes)]
	[ApiResponse(HttpStatusCode.BadRequest, "L'entité CompteurValeur ne contient pas tous les champs demandés")]
	[ApiResponse(HttpStatusCode.NotFound, "L'entité CompteurValeur spécifiée est introuvable")]
