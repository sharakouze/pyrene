...
namespace Tmpi.Pyrene.ServiceModel
{
	...
	/// </summary>
	[Route("/Compteur/{Id}", HttpVerbs.Get, Summary = "Retourne une entité Compteur à partir de son id", Notes = SwaggerDescriptions.GetByIdRequestNotes)]
	[ApiResponse(HttpStatusCode.BadRequest, "L'entité Compteur ne contient pas tous les champs demandés")]
	...
	/// </summary>
	[Route("/Compteur/{Id}", HttpVerbs.Delete, Summary = "Supprime une entité Compteur à partir de son id", Notes = SwaggerDescriptions.DeleteByIdRequestNotes)]
	[ApiResponse(HttpStatusCode.NotFound, "L'entité Compteur spécifiée est introuvable")]
	...
	/// </summary>
	[Route("/Compteur/{Id}", HttpVerbs.Patch, Summary = "Modifie partiellement une entité Compteur à partir de son id", Notes = SwaggerDescriptions.PatchByIdRequestNotes)]
	[ApiResponse(HttpStatusCode.BadRequest, "L'entité Compteur ne contient pas tous les champs demandés")]
	[ApiResponse(HttpStatusCode.NotFound, "L'entité Compteur spécifiée est introuvable")]
